#!/usr/bin/env bash
# Katifetch - Bazzite Steam Deck GNOME Edition by kati dev
...
info=(
"${c_purple_mid}󱋩  bazzite: Steam Deck GNOME Edition ${c_reset}"
...
""
"${c_blue_light}󰕮${c_reset}  ${c_blue_light}GNOME Shell $(gnome-shell --version | awk '{print $3}' 2>/dev/null || echo N/A)${c_reset}"
"${c_blue_light}${c_reset}  ${c_blue_light}Mutter (Wayland)${c_reset}"
